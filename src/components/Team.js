...
import Swarna from "../utils/Team/clubhead1.png";
import Cipriyano from "../utils/Team/clubmentor.png";
import Rithvik from "../utils/Team/clubhead2.png";
import Fa from "../utils/Team/Fa.jpeg";
    ...
    >
      ...
      <div className="container py-5">
        <div className="row text-center justify-content-center">
          {[
            { name: "Dr. Garima Shakya", role: "Faculty Advisor", photo: Fa },
      ...
      <div className="container py-5">
      <ul className="d-flex justify-content-center flex-wrap gap-3 mb-4 list-unstyled">
  {[
